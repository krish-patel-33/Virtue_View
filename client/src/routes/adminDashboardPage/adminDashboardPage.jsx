      ...
      <div className="mx-auto max-w-7xl space-y-8">
        <div>
          ...
          <p className="mt-2 text-sm text-gray-500">
            Review platform totals, manage users, and update seller properties from one place.
          </p>
        </div>
          ...
          <div className="grid gap-6 xl:grid-cols-[1.4fr_0.9fr]">
            ...
            <div className="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-gray-100">
              ...
              <form onSubmit={handlePropertySubmit} className="mt-6 space-y-4">
                ...
                <textarea value={propertyForm.desc} onChange={(e) => setPropertyForm((prev) => ({ ...prev, desc: e.target.value }))} rows={5} placeholder="Description" className="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm outline-none" disabled={!propertyForm.id} />
                <div className="flex gap-3">
